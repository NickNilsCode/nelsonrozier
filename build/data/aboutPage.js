...
module.exports = [{
  ...
  type: "p",
  content: "For skilled representation you can trust to always put you first, turn to Nelson, Rozier, & Christenson. To schedule a free initial consultation, call ".concat(phoneorcontact, ".")
}, {
  type: "p",
