let {
  ...
  accidentsinvolvingcowsorotherlivestock,
  braininjuries,
  spineinjuriesandamputations,
  ...
  rearendcollisions,
  wrongfuldeath,
  braininjuriesspineinjuriesandamputations,
  commercialtrucksandtractortrailers,
  spinalinjuries,
  amputations,
  nelsonrozier,
  personalinjury,
  ...
  dangerouslocalintersectionsandstopsigns,
  slipandfall,
...
module.exports = [
  {
    ...
    description:
      "Nothing can compensate for the impairment, disability and death caused by a car accident, but we can help you recover. Hire our car and auto accident attorneys to fight for you.",
    keywords:
      "Car & Auto Accident Attorneys, Best Accident Attorneys California, Auto Accident lawyer",
    ...
    content: [
      ...
      },
      {
        type: "ul",
        className: "",
        content: `<li>${commercialtrucksandtractortrailers}</li>
        <li>${motorcycleaccidents}</li>
        <li>${bicycleandpedestrianaccidents}</li>
        <li>${accidentsinvolvingcowsorotherlivestock}</li>
        <li>${braininjuries}</li>
        <li>${spineinjuriesandamputations}</li>
        <li>${dangerousintersectionsandobscuredstopsigns}</li>
        <li>${underinsuredanduninsuredmotoristclaims}</li>
        <li>${drunkdrivers}</li>
        <li>${distracteddrivers}</li>
  ...
  },
  {
    ...
    id: "truck-accidents",
    title:
      "Experienced Truck Accident Attorney | Visalia Truck Accident Attorneys",
    description:
      "Work with an experienced truck accident attorney to recover your financial losses and damage caused by the accident. We have 40 years’ experience.",
    keywords:
      "Experienced truck accident attorney, Visalia Truck Accident Attorneys",
    ...
    content: [
      ...
      },
      {
        type: "p",
        className: "",
        content: `We are Nelson, Rozier, & Christenson — a personal injury law firm with more than 40 years of combined experience providing compassionate, experienced and effective representation from our office in Visalia. For a ${freeconsultation}, call ${phoneorcontact}.`,
      },
      {
        type: "p",
        className: "",
        content: `We have a history of achieving ${successfulresults} for clients who have suffered injuries in truck accidents involving a wide range of circumstances. Follow the links below to learn more:`,
      },
      {
        type: "ul",
        className: "",
        ...
        <li>${wrongfuldeath}</li>
        <li>${braininjuriesspineinjuriesandamputations}</li>
      ...
      },
      {
        type: "p",
        className: "",
        content: `If you would like to discuss your truck accident case with us, you can call ${phoneorcontactoffice}. One of our attorneys would be glad to drop by your residence on his or her way home from work this evening.`,
      },
      {
        type: "p",
        className: "",
  ...
  },
  {
    ...
    title:
      "Motorcycle Accident Attorneys, Visalia | Motorcycle Accident Attorney Firm",
    description:
      "Motorcycle riders are most at risk and often receive catastrophic injuries due to others' negligence. Work with our expert motorcycle accident attorneys in Visalia to represent you.",
    keywords:
      "Motorcycle Accident Attorney firm, Motorcycle Accident Attorneys Visalia",
    ...
    content: [
      ...
      },
      {
        type: "ul",
        className: "",
        content: `<li>${traumaticbraininjuries}</li>
        <li>${spinalinjuries}</li>
        <li>${amputations}</li>
        <li>Road rash</li>`,
      },
      {
      ...
      },
      {
        type: "p",
        className: "",
        content: `At ${nelsonrozier}, our firm understands how to build strong cases for injured motorcycle riders. We know most people are not riders and may not understand the risks motorcycle riders face because of careless drivers. Our strength in the courtroom allows us to clearly and persuasively illustrate why the other motorist was at fault, the extent of your injuries and what it is going to take to help you put your life back together.`,
      },
      {
        type: "h2",
        className: "",
      ...
      },
      {
        type: "p",
        className: "",
        content: `When you have been seriously injured in a motorcycle accident, Nelson, Rozier, & Christenson, can offer you the skilled and experienced help you need. To schedule a free initial consultation, call ${phoneorcontact}.`,
      },
      {
        type: "p",
        className: "",
  ...
  },
  {
    ...
    title:
      "Professional Accident Attorney Services | DUI Accident Attorneys in Visalia",
    description:
      "DUI accidents are not mistakes. Do not suffer from other people’s negligence. File a DUI lawsuit against the other driver with our experienced DUI accident attorneys in Visalia.",
    keywords:
      "DUI Accident Attorneys in Visalia, DUI Accident Attorney services, Professional Accident Attorney services",
    ...
    content: [
      ...
      },
      {
        type: "p",
        className: "",
        content: `Have you or a loved one been the victim of impaired driving? At ${nelsonrozier}, we will help you lead a DUI lawsuit against the other driver. We’ll also gather the evidence so that you don’t relive the trauma of your accident. Our every effort will be to recover damages for your property, medical bills, pain and suffering, and lost wages.`,
      },
      {
        type: "p",
        className: "",
      ...
      },
      {
        type: "p",
        className: "",
        content: `Call ${phoneorcontact} to consult with Nelson, Rozier, & Christenson drunk driving accident attorneys.`,
      },
      {
        type: "h2",
        className: "",
      ...
      },
      {
        type: "p",
        className: "",
        content: `To go through these questions and more, all ${phoneorcontact} to get DUI Accident Attorney services in Visalia, CA.`,
      },
    ],
  },
  {
    ...
    title:
      "Visalia Distracted Driving Accident Attorneys | Nelson, Rozier, & Christenson",
    description:
      "If you have been suffering due to someone else’s distracted driving, you have the right to represent yourself. Fight for your rights with our distracted driving accident attorneys.",
    keywords:
      "Professional Accident Attorneys, Visalia Distracted Driving Accident Attorneys",
    ...
    content: [
      ...
      },
      {
        type: "p",
        className: "",
        content: `At ${nelsonrozier}, our firm is committed to helping our clients secure the compensation they need to be able to recover from the injuries they have suffered. We are skilled litigators with decades of combined ${personalinjury} experience holding drivers accountable for the harm they have caused. The law prohibits anyone from using a cellphone while driving. If someone caused an accident that injured you while he or she was on his or her phone, we can help you fight for the compensation you deserve.`,
      },
      {
        type: "h2",
        className: "",
      ...
      },
      {
        type: "p",
        className: "",
        content: `For the skilled and experienced help you need after being injured by a distracted driver, turn to Nelson, Rozier, & Christenson. To schedule a free initial consultation, call ${phoneorcontact}.`,
      },
      {
        type: "p",
        className: "",
  ...
  },
  {
    ...
    title:
      "Best Accident Attorneys, California | Uninsured or Under-Insured Motorist Lawyer",
    description:
      "Receiving compensation from uninsured or under-insured motorists is difficult but our motorist accident attorneys in California can help you. Schedule a consultation.",
    keywords:
      "Best Accident Attorneys California, Motorist Accident Attorneys California,  Uninsured or Underinsured Motorist Lawyer",
    ...
    content: [
      ...
      },
      {
        type: "p",
        className: "",
        content: `Our experience as personal injury litigators allows us to offer real hope and real help to people like you. Turn to Nelson, Rozier, & Christenson. To schedule a free initial consultation, call ${phoneorcontact}.`,
      },
      {
        type: "p",
        className: "",
  ...
  },
  {
    ...
    title:
      "Rear-End Collision Attorneys | Visalia | Nelson, Rozier, & Christenson",
    description:
      "Nothing can be done about rear-end collisions. Work with our top rear-end collision attorneys to recover your losses. Contact us to schedule a free initial consultation.",
    keywords:
      "Rear-End Collision Attorneys, Top Legal consultation firm Visalia",
    ...
    content: [
      ...
      },
      {
        ...
        <li>${traumaticbraininjuries} (TBI)</li>
        <li>${spinalinjuries} (paraplegia, quadriplegia, partial paralysis)</li>
        <li>Broken bones</li>`,
      },
      {
        type: "h2",
      ...
      },
      {
        type: "p",
        className: "",
        content: `At ${nelsonrozier}, our attorneys have decades of combined personal injury experience that we use to craft the most effective cases. Our experience includes having defended insurance companies against personal injury claims in the past. That experience gives us an insider’s perspective as to how the insurance companies approach and act on injury claims.`,
      },
      {
        type: "p",
        className: "",
      ...
      },
      {
        type: "p",
        className: "",
        content: `Nelson, Rozier, & Christenson, is dedicated to helping people secure the full compensation they deserve after being injured in an accident. To schedule a free initial consultation, call ${phoneorcontact}.`,
      },
      {
        type: "p",
        className: "",
  ...
  },
  {
    ...
    description:
      "Are you a victim of improper signage? We understand not all accidents are caused by dangerous drivers. We will represent you with our road accident lawyers in Visalia.",
    ...
    content: [
      ...
      },
      {
        type: "p",
        className: "",
        content: `We provide personalized, caring and compassionate legal service. We have a long history of achieving successful results for clients who deserve compensation for serious accidents. If you would like to schedule a free consultation, call us today at ${phoneorcontactoffice}.`,
      },
      {
        type: "h2",
        className: "",
      ...
      },
      {
        type: "ul",
        className: "",
        content: `<li>${commonlyaskedquestions}</li>
        <li>${caraccidents}</li>
  ...
  },
  {
    ...
    description:
      "Have you received injuries in a bicycle or pedestrian accident? Do not fall back on the driver’s excuses. Defend yourself with our expert bicycle and pedestrian attorneys.",
    ...
    content: [
      ...
      },
      {
        type: "p",
        className: "",
        content: `To schedule a free consultation, call ${phoneorcontactoffice}. One of our attorneys would be happy to drop by your house on the way home this evening.`,
      },
      {
        type: "p",
        className: "",
        content: `We have a strong record of achieving ${successfulresults} for clients in a wide variety of cases. Follow the related links below to learn more:`,
      },
      {
        type: "ul",
        className: "",
        ...
        <li>${braininjuries}</li>
        <li>${spineinjuriesandamputations}</li>
        <li>${dangerouslocalintersectionsandstopsigns}</li>
        <li>${wrongfuldeath}</li>`,
      },
      {
        type: "h2",
      ...
      },
      {
        type: "p",
        className: "",
        content: `At ${nelsonrozier}, we are committed to helping those who were injured in bicycle and pedestrian accidents. Our decades of combined experience provide our clients with the advantage they need as they pursue the compensation they deserve. Let us help you effectively pursue the full compensation you need.`,
      },
      {
        type: "p",
        className: "",
  ...
  },
  {
    ...
    description:
      "If any type of accident has led to a traumatic brain injury (TBI), you can pursue compensation. Our brain injury attorney in CA can help you recover your losses.",
    ...
    content: [
      ...
      },
      {
        type: "p",
        className: "",
        content: `At ${nelsonrozier}, we understand the impact a TBI can have. From the most severe cases to the most subtle, a TBI can permanently change every aspect of a person’s life. Our firm has decades of combined ${personalinjury} experience that we utilize to help those who have suffered a TBI and their loved ones. Our extensive litigation experience means that we understand what it takes to win at trial. That experience includes having defended insurance companies against claims in the past. That knowledge of how insurance companies approach and value these types of cases helps us build a strategy that is tailored to create the best results for you.`,
      },
      {
        type: "h2",
        className: "",
      ...
      },
      {
        type: "p",
        className: "",
        content: `Nelson, Rozier, & Christenson, offers highly effective personal injury representation to those who have suffered a TBI. To schedule a free initial consultation, call ${phoneorcontact}.`,
      },
      {
        type: "p",
        className: "",
  ...
  },
  {
    ...
    description:
      "Burns are horrific injuries. Hire our burn injuries attorneys in CA to represent you and recover your losses. Schedule a free consultation.",
    keywords:
      "Burn Injuries Attorneys CA, Experienced attorney visalia, Best fire and Burn Injury Lawyer",
    ...
    content: [
      ...
      },
      {
        type: "p",
        className: "",
        content: `At ${nelsonrozier}, our firm understands the challenges burn victims are facing as they attempt to recover their health and put their lives back together. We have the skill and decades of combined ${personalinjury} experience necessary to be able to build strong cases that clearly illustrate the full impact your burn injuries have had on your life and what it is going to take to help you reclaim your life.`,
      },
      {
        type: "h2",
        className: "",
      ...
      },
      {
        type: "p",
        className: "",
        content: `Nelson, Rozier, & Christenson, offers highly effective legal representation to those who have suffered serious burns. To schedule a free initial consultation, call ${phoneorcontact}.`,
      },
      {
        type: "p",
        className: "",
  ...
  },
  {
    ...
    description:
      "Are you suffering from a spinal cord injury and/or amputations due to someone else’s fault? Contact our spinal cord injury lawyer to secure the compensation you need. We have 40 years’ experience.",
    ...
    content: [
      ...
      },
      {
        type: "p",
        className: "",
        content: `At ${nelsonrozier}, we are skilled litigators with decades of combined experience that we use to help people who have suffered the most serious ${personalinjuries}. Our experience includes having defended insurance companies in the past. That experience can be invaluable in understanding what strategy will be the most effective in securing the compensation you need. Further helping us craft strong cases is the fact that we work with all necessary outside experts to help us understand your needs now and in the future.`,
      },
      {
        type: "h2",
        className: "",
      ...
      },
      {
        type: "p",
        className: "",
        content: `Nelson, Rozier, & Christenson, is committed to helping those who have suffered spinal cord injuries and amputations. To schedule a free initial consultation, call ${phoneorcontact}.`,
      },
      {
        type: "p",
        className: "",
  ...
  },
  {
    ...
    description:
      "Suffering from a slip or fall injury due to wet floors with no warning signs? Let us represent you and recover compensation for you with our expert Visalia slip and fall attorneys.",
    ...
    content: [
      ...
      },
      {
        type: "p",
        className: "",
        content: `We are Nelson, Rozier, & Christenson. We are a personal injury law firm with more than 40 years of combined experience practicing law. We provide personal, attentive, compassionate and effective representation to clients facing extreme hardship. For a free consultation, call ${phoneorcontact}.`,
      },
      {
        type: "h2",
        className: "",
      ...
      },
      {
        type: "p",
        className: "",
        content: `Using these techniques, we have maintained a solid history of achieving ${successfulresults} for clients in situations just like yours.`,
      },
      {
        type: "h2",
        className: "",
      ...
      },
      {
        type: "p",
        className: "",
        content: `If you would like to schedule a free initial consultation to discuss a slip-and-fall injury, call us today at ${phoneorcontactoffice}. If it works out, one of our attorneys would be happy to drop by your home on his or her way home from work this evening.`,
      },
    ],
  },
  {
    ...
    description:
      "For animal-related injuries, owners of animals are often responsible. Work with our best animal injury attorneys to recover the compensation you deserve.",
    keywords:
      "Best animal injury attorney near me, Visalia Dog Bite Attorneys, Dog Bite Attorneys CA",
    ...
    content: [
      ...
      },
      {
        type: "p",
        className: "",
        content: `Nelson, Rozier, & Christenson, is a personal injury law firm in Visalia, California, with more than 40 years of combined legal experience. We have a history of achieving ${successfulresults} for our clients, and we focus on providing personalized, compassionate and attentive service. If you would like to schedule a <strong>free initial consultation</strong>, call today at ${phoneorcontactoffice}.`,
      },
      {
        type: "h2",
        className: "",
  ...
  },
  {
    ...
    description:
      "Our expert top wrongful death attorneys in CA will tell your story to the judge, jury and insurance companies to get you the help you deserve.",
    keywords:
      "Top Wrongful Death Attorneys CA, Visalia Wrongful Death Attorneys",
    ...
    content: [
      ...
      },
      {
        type: "p",
        className: "",
        content: `To schedule a ${freeconsultation}, call us today at ${phoneorcontactoffice}. One of our attorneys would be happy to drop by and discuss your situation on the way home this evening.`,
      },
      {
        type: "h2",
        className: "",
      ...
      },
      {
        type: "p",
        className: "",
        content: `If you would like to schedule a ${freeconsultation} to discuss your legal options for moving forward after the wrongful death of a loved one, call our office today at ${phoneorcontact}. We are ready to listen.`,
      },
    ],
  },
];
