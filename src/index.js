...
fs.readFile(
  "./dist/js/personalinjurytemplate.bundle.min.js",
  "utf8",
  (err, data) => {
    if (err) console.log("ERR", err);
...
app.get("/", (req, res) => {
  ...
  res.send(
    returnHTML(
      ...
      homeBundle,
      HomeRoot,
      "Best Personal Injury Attorney California | Free Legal Consultation Visalia – NRC Law Firms | Nelson, Rozier, & Christenson",
      "Do not suffer from other people’s mistakes. Partner with NRC Law, the best personal injury attorneys in California. We represent plaintiffs and defendants.",
      "Personal injury attorney California, Free Legal Consultation Visalia, Best Injury Attorney, Best Visalia law firm, Visalia top Experienced law firm, Best Legal Attorney Services California, Best Legal attorney California, Experienced Legal attorney Visalia, Visalia Personal Injury Attorneys, experienced attorney California"
    )
  );
});
app.get("/about", (req, res) => {
  ...
  res.send(
    returnHTML(
      ...
      aboutBundle,
      AboutRoot,
      "About Your Visalia Personal Injury Lawyers | Nelson, Rozier, & Christenson",
      "Our firm has been located in Visalia since 1982. Our attorneys all live in our area and were raised here. We know the people of our community and the surrounding areas.",
      ""
    )
  );
});
app.get("/personal-injury", (req, res) => {
  ...
  res.send(
    returnHTML(
      ...
      personalinjuryBundle,
      PersonalinjuryRoot,
      "Best Injury Lawyers Visalia, California | Experienced Personal Injury Attorneys",
      "Get personalized legal representation by a compassionate, dedicated and experienced personal injury lawyer in California. We take cases on a contingency fee basis.",
      "Best injuries lawyer California, Professional personal injury lawyer, Attorney for personal injury california, Experienced personal injury attorney"
    )
  );
});
...
app.get("/personal-injury/:id", (req, res) => {
  ...
  const permanentRedirectPages = [
    "medical-malpractice",
    "elder-abuse-nursing-home-claims",
    "birth-injuries",
  ];

  if (permanentRedirectPages.includes(req.params.id)) {
    return res.redirect(301, "/personal-injury");
  }
...
app.get("/case-results", (req, res) => {
  ...
  res.send(
    returnHTML(
      ...
      caseresultsBundle,
      CaseresultsRoot,
      "Best Visalia Law Firm Case Results | Nelson, Rozier, & Christenson",
      "See our successful case results if you have a similar case and need an attorney, call us today at 559-713-0159 or contact our office to schedule a free consultation.",
      ""
    )
  );
});
app.get("/faq", (req, res) => {
  ...
  res.send(
    returnHTML(
      ...
      faqBundle,
      FaqRoot,
      "FAQ Personal Injury Visalia | Nelson, Rozier, & Christenson",
      "Learn more about personal injury claims with this FAQ for personal injury in California. Contact Nelson, Rozier, & Christenson for help today!",
      ""
    )
  );
});
app.get("/blog", (req, res) => {
  ...
  res.send(
    returnHTML(
      ...
      blogBundle,
      BlogRoot,
      "Read Our Latest Blog & News About Personal Injury Visalia | Nelson, Rozier, & Christenson",
      "Read Our Latest Blog & News posts on Personal Injury, Injuries, car accidents, and many more. Visit our website now!",
      "Personal Injury Visalia"
    )
  );
});
app.get("/blogcattemplate", (req, res) => {
  ...
  res.send(
    returnHTML(
      ...
      blogcattemplateBundle,
      BlogcattemplateRoot,
      "Blog & News About Personal Injury Attorneys",
      "Attorneys",
      ""
    )
  );
...
app.get("/contact", (req, res) => {
  ...
  res.send(
    returnHTML(
      ...
      contactBundle,
      ContactRoot,
      "Contact for Best Legal Services California | Nelson, Rozier, & Christenson",
      "If you need an Personal Injury Attorneys in California, let us help.  Call 559-713-0159 or fill out the form to schedule your free consultation.",
      ""
    )
  );
});
app.get("/disclaimer", (req, res) => {
  ...
  res.send(
    returnHTML(
      ...
      disclaimerBundle,
      DisclaimerRoot,
      "Disclaimer | Nelson, Rozier, & Christenson",
...
app.get("/sitemap", (req, res) => {
  ...
  res.send(
    returnHTML(
      ...
      sitemapBundle,
      SitemapRoot,
      "Sitemap | Nelson, Rozier, & Christenson",
      "",
      ""
    )
  );
...
app.get("/privacy", (req, res) => {
  ...
  res.send(
    returnHTML(
      ...
      privacypolicyBundle,
      PrivacypolicyRoot,
      "Our Privacy Policy | Nelson, Rozier, & Christenson",
...
app.get("/attorney/:name", (req, res) => {
  ...
  res.send(
    returnHTML(
      ...
      attorneytemplateBundle,
      AttorneytemplateRoot,
      "Meet Your Visalia Personal Injury Lawyers | Nelson, Rozier, & Christenson",
      "",
      ""
    )
  );
...
app.get("/search", (req, res) => {
  ...
  res.send(
    returnHTML(
      ...
      searchBundle,
      SearchRoot,
      "Search | Nelson, Rozier, & Christenson",
      "",
      ""
    )
  );
...
app.get("/error", (req, res) => {
  ...
  res.send(
    returnHTML(
      ...
      notfoundBundle,
      NotFoundRoot,
      "404 Not Found | Nelson, Rozier, & Christenson",
      "",
      ""
    )
  );
...
app.post("/emailer", (req, res) => {
  ...
  transporter.sendMail(
    {
      from: email,
      to: [cryptr.decrypt(config.nrEmail), cryptr.decrypt(config.nr2Email)],
...
var mongoUri = process.env.MONGODB_URI
  ...
  : "mongodb+srv://" +
    cryptr.decrypt(config.dbuser) +
    ":" +
    cryptr.decrypt(config.dbpass) +
    "@nelsonrozier.1dnpj.mongodb.net/nelsonrozier?retryWrites=true&w=majority";
