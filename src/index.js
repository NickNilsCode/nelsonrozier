...
app.get('/blog', (req, res) => {
  ...
  res.set('Cache-Control', 'public, max-age=31557600');
  res.send(returnHTML(data, blogBundle, BlogRoot, "Read Our Latest Blog About Personal Injury Visalia | Nelson Rozier & Christenson", "", ""));
});
...
app.get('/contact', (req, res) => {
  let data = "";
  res.set('Cache-Control', 'public, max-age=31557600');
  res.send(returnHTML(data, contactBundle, ContactRoot, "Contact for Best Legal Services California | Nelson Rozier & Christenson", "", ""));
});
